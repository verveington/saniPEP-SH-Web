...
const viteEnv = (import.meta as ImportMeta & { env?: { DEV?: boolean; VITE_PORTAL_BACKEND_URL?: string } }).env;
const publicRequestBackendUrl = viteEnv?.VITE_PORTAL_BACKEND_URL ?? (viteEnv?.DEV ? "http://localhost:4100" : undefined);
