...
export const patientSearchIndex: SearchEntry[] = [
  {
    ...
    summary: "Kann ein Anlass für eine qualifizierte Kompressionsberatung sein. Empfehlung: Beratungstermin anfragen.",
    recommendedRoute: "/lymphoedem-lipoedem-narbenkompression",
    primaryAction: "appointment",
    relatedTerms: ["schwere Beine", "Kompressionsberatung", "Druckschmerz", "Kompressionsstrümpfe nach Maß"],
    priority: 1,
  },
  {
    id: "symptom-lipoedema-pain",
    category: "symptom",
    term: "Druckschmerz an den Beinen",
    title: "Druckempfindliche oder schwere Beine",
    summary: "Ruhige Erstberatung mit Fragebogen, Rezeptlage und Terminwunsch.",
  ...
  },
  {
    ...
    category: "symptom",
    term: "Brustprothese nach Operation",
...
export const fallbackRouteByAction: Record<SearchIntentResult["primaryAction"], Route> = {
  appointment: "/termin-anfragen",
  upload: "/rezept-upload",
  configure: "/inkontinenz-pflegehilfsmittel",
  portal: "/portal/login",
  inquiry: "/kontakt",
};
