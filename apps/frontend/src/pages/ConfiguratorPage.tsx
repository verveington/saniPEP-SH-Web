...
import { validateCareConfigurationInput } from "../lib/formValidation";
import { submitPublicRequest, type PublicRequestReceipt } from "../lib/publicRequestApi";
import type { CareConfigurationInput } from "../lib/types";

export default function ConfiguratorPage({ onConversion }: { onConversion: TrackConversion }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      onConversion({ stage: "request-submitted", route: "/inkontinenz-pflegehilfsmittel" });
    } catch {
